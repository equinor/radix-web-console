...
import { EnvironmentCardLayout } from '../../../components/environments-summary/environment-card'
import { activeFrom, consistentBaseArgs, deploymentName, utilization, vulnerabilities } from './environmentCard.mock'
