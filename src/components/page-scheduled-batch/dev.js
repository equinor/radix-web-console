...
new Server({
  ...
  routes() {
    ...
    this.get(
      '/api/v1/applications/:appName/environments/:envName/jobcomponents/:jobComponentName/scheduledbatches/:scheduledBatchName/logs',
      (_, request) =>
    ...
    {props.map((p, i) => (
      ...
      >
        <PageScheduledJob
          ...
          scheduledBatchName={p.scheduledBatchList[0].name}
        />
      </div>
    ))}
  </>
