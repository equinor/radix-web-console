...
export function environmentVulnerabilitySummarizer(envScans?: EnvironmentVulnerabilities): VulnerabilitySummary {
  ...
  return aggregateVulnerabilitySummaries([...componentSummaries, ...jobSummaries])
}
