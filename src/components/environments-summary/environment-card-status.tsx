...
import { check, error_outlined, report_bug, run, stop, warning_outlined } from '@equinor/eds-icons'
...
export const EnvironmentVulnerabilityIndicator = ({ title, summary, size = 24, ...rest }: Props) => {
