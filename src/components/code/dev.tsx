import { Log, type LogProps } from './log'

const testdata: Array<LogProps> = [
  {
    content:
  ...
  { content: 'A short code example', copy: true, download: true },
]
...
function CodeContainer({ ...props }: { content: string; copy?: boolean; download?: boolean }) {
  return (
    <div
      style={{
