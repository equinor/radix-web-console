...
describe('parseContainerImageDigest', () => {
  it('parses an image with registry+path and digest', () => {
    expect(
      ...
      image:
        'radix-job-demo-server@sha256:d40cda01916ef63da3607c03785efabc56eb2fc2e0dab0726b1a843e9ded093f',
      digest:
        'sha256:d40cda01916ef63da3607c03785efabc56eb2fc2e0dab0726b1a843e9ded093f',
    });
  });
...
describe('parseImageTag', () => {
  it('parses an image with registry+path and tag', () => {
    expect(
      parseImageTag('radixdev.azurecr.io/radix-job-demo-server:248o5')
    ).toEqual({
      repository: 'radix-job-demo-server',
