...
import { ScheduledJobPage } from './ScheduledJobPage'

const testData: Array<Parameters<typeof ScheduledJobPage>[0] & { jobData: ScheduledJobSummary }> = [
  {
...
export default (
  <>
    {testData.map(({ appName, envName, jobComponentName, scheduledJobName }, i) => (
      ...
      >
        <ScheduledJobPage {...{ appName, envName, jobComponentName, scheduledJobName }} />
      </div>
    ))}
  </>
)
