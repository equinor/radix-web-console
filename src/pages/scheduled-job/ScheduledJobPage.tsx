...
import { EnvironmentVariableTable } from './components/EnvironmentVariableTable'
import { JobReplica } from './components/JobReplica'
import { ScheduledJobOverview } from './components/ScheduledJobOverview'

import './style.css'

export const ScheduledJobPage: FunctionComponent<{
  appName: string
...
export default withRouteParams(ScheduledJobPage)
