...
import { ScheduledBatchPage } from './ScheduledBatchPage'

const testData: Array<
  Parameters<typeof ScheduledBatchPage>[0] & {
...
export default (
  <>
    {testData.map(({ appName, envName, jobComponentName, scheduledBatchName }, i) => (
      ...
      >
        <ScheduledBatchPage {...{ appName, envName, jobComponentName, scheduledBatchName }} />
      </div>
    ))}
  </>
)
